...
LINES = ["KDE Plasma (Heavy)", "XFCE4 (Lightweight)",
...
class AgarVM(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Vertical(
            Horizontal(
                ...
                Select(id="de", value="KDE Plasma (Heavy)",
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        if event.button.id == "in":
            data = {"defaultapps": self.query_one("#defaultapps").selected, "programming": self.query_one(
                "#programming").selected, "apps": self.query_one("#apps").selected, "enablekvm": True, "DE": self.query_one("#de").value}
            savejson(data)
            app.exit()
